...
<?php
      ...
      echo "<td>";
      Ownership::dropdown(['value' => $this->fields["ownership"], 'rand' => $randDropdown]);
      ...
      echo "</td>";
echo "<td><label for='dropdown_costcentres_id$randDropdown'>".__('Cost Centre')."</label></td>";
      echo "<td >";
      Cost::dropdown(['value' => $this->fields["costcentres_id"], 'rand' => $randDropdown]);
      echo "</td></tr>";
